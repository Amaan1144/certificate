...
export function AiditeLogo() {
  return (
    <div className="flex h-12 items-center justify-center rounded-md bg-white px-3">
      <Image
...
export function CerconLogo() {
  return (
    <div className="flex h-12 items-center justify-center rounded-md bg-[#1a5fb4] px-4">
...
export function LavaLogo() {
  return (
    <div className="flex h-12 items-center gap-1.5 rounded-md bg-[#111111] px-3">
